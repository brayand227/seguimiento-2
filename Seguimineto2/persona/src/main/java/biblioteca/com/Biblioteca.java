...
public class Biblioteca implements Prestamo {
    ...
    private Collection<Libro> librosBiblioteca;
     ...
     */
    public void registrarDevolucion(Libro libro, Data fecha) {

        for (PrestamoLibro i : librosPrestados) {

            if (i.getLibro().equals(libro) && i.getFechaPrestamo().equals(fecha)) {
